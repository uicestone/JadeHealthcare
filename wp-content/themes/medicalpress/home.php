		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="features-intro clearfix">
					...
					<a class="read-more" href="<?=site_url()?>/category/service-product/service/">我们的服务</a>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-sm-6 single-feature">
						<div class="row">
							...
							<div class="col-sm-9">
								<h3>就医绿色通道</h3>
								<p>为了方便就医，减少就诊等待时间，更好享受医疗资源，颉安健康联合各大医院设立的“专业陪诊”服务，即可以享受优先就诊预约、优先医生预约、优先安排住院、优先安排手术等服务。</p>
							</div>
						</div>
					</div>
